...
class StoresolicitantesRequest extends FormRequest
{
    ...
    public function rules(){
        return [
            ...
            'identificaciones_id'=>['required','integer'],
            'clientes_id' => ['nullable'],
            'numero_documento'   =>['required','string','min:3','max:20'],
            'telefono'           =>['required','string','size:8'],#Acepta exactamente 8 carácteres
            'correo'             =>['required','email','min:3','max:50','unique:solicitantes,correo'],
        ];
    }
