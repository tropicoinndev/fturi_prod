...
class StoremunicipiosRequest extends FormRequest
{
    ...
    {
        return [
            'municipio'       =>['required','string','unique:municipios','min:3','max:100'],
            'codigo_postal'   =>['required','string','unique:municipios','min:2','max:5'],
            'codigo_mh'       =>['required','string','unique:municipios','min:2','max:2'],
            'departamentos_id'=>['required','numeric']
        ];
    }
