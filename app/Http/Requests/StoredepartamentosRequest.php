...
class StoredepartamentosRequest extends FormRequest
{
    ...
    {
        return [
            'departamento' =>['required','string','unique:departamentos','min:3','max:100'],
            'codigo_postal'=>['required','string','unique:departamentos','min:2','max:5'],
            'codigo_mh'    =>['required','string','unique:departamentos','min:2','max:2'],
            'paises_id'    =>['required','numeric']
        ];
    }
