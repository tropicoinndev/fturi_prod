...
class Storetipo_habitacionesRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'tipo_habitacion'=>['required','string','unique:tipo_habitaciones','min:2','max:100'],
            'codigo'         =>['required','string','min:2','max:10']
        ];
    }
