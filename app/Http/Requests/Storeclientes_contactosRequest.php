...
class Storeclientes_contactosRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'valor'        => ['required', 'string', 'min:3', 'max:100'],
            'observacion'  => ['nullable', 'string', 'min:3', 'max:100'],
            'contactos_id' => ['required', 'numeric'],
