...
class Storetipo_registrosRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'tipo' =>['required','string','unique:tipo_registros','min:3','max:100'],
            'token'=>['required','numeric','unique:tipo_registros','min:1','max:9999']
        ];
    }
