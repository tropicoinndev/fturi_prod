...
class Storeactividades_economicasRequest extends FormRequest
{
    /**
    ...
    public function rules(){
        return [
            'codigo'   =>['required','string','unique:actividades_economicas','min:2','max:5'],
            'actividad'=>['required','string','unique:actividades_economicas','min:3','max:100'],
        ];
    }
