...
class UpdateproveedoresRequest extends FormRequest
{
    ...
    {
        return [
            'proveedor'    => ['required', 'string', 'min:3', 'max:100'],
            'nrc'          => ['nullable', 'string', 'min:1', 'max:8', 'regex:/^[0-9]{1,8}$/'],
            'nit'          => ['nullable', 'string', 'min:9', 'max:14', 'regex:/^[0-9]{14}$/'],
            'dui'          => ['nullable', 'string', 'min:9', 'max:9', 'regex:/^[0-9]{9}$/'],
