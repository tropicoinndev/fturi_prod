...
class Storeestado_habitacionesRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'estado_habitacion'=>['required','string','unique:estado_habitaciones','min:3','max:100'],
            'token'            =>['required','string','min:1','max:99999']
        ];
    }
