        ...
        <div class="card-body p-2 ">
            <div class="row mb-4">
                <div class="col-12 text-uppercase h3">
                    Creación de libro de ventas a contribuyentes
                </div>
            </div>
            <form action="{{ route('libros.contribuyentes_report') }}" method="post">
                @csrf
                <div class="row">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="cantidad" name="cantidad" value="15" required>
                    </div>
                    <div class="mb-3">
