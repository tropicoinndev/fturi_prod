...
<head>
    ...
    <title>REPORTE DE MONTAJES DE SALONES</title>
    ...
    <main>
        ...
        <div class="row col-12">
            <div class="row">
                ...
                <div class="col-6 text-center"><strong>REPORTE DE MONTAJES DE SALONES</strong></div>
            </div>
            ...
            <div class="row ">
                    <div class="row-group">
                        <div class="row-item">
                            ...
                            <span class="label"
                                style=" width: 639px; border-bottom: 1px solid black;">{{ implode(', ', $evento->salones->pluck('salones.salon')->toArray()) }}</span>
                ...
                <div class="row">
                    ...
                    <span class="label text-uppercase" style=" width: 580px; border-bottom: 1px solid black;">
                        @if ($salonesSeparados)
                            Separados
                        @else
                            Unidos
            ...
            <div class="row">
                ...
                <span class="label"
                    style=" width: 242px; border-bottom: 1px solid black;">{{ $evento->clientes->contactos[0]->valor ?? 'No posee contacto aun' }}</span>
            ...
            <div class="row">
                <span class=" label text-uppercase" style="visibility:hidden;">Forma de pago:</span>
                <span class="label" style=" width: 200px; visibility:hidden;">{{ $evento->forma_pagos->forma }}</span>
            ...
            <div class="row">
                        <span class="label text-uppercase">Encargado del evento:</span>
                        <span class="label"
                            style="width: 500px; white-space: nowrap;">
                            <strong class="text-uppercase font-bold">

                                {{ $evento->encargado ?? 'sin asignarse' }}
            ...
            <div class="row col-12">
                ...
                <div class="row col-12 text-uppercase">
                    ...
                    <div class="row">
                        <span class="label">Tipo de mesas:</span>
                        <span class="label" style="width: 585px; border-bottom: 1px solid black;">
                    ...
                    <div class="row">
                        ...
                        <span class="label" style="width: 626px; border-bottom: 1px solid black;">
                            {{ $evento->sonidos->sonido ?? 'No es requerido' }}
                        </span>
                    </div>

                    <div class="row">
                        <span class="label">Pista de baile:</span>
                        <span class="label" style="width: 585px; border-bottom: 1px solid black;">
                    ...
                    <div class="row">
                        ...
                        <span class="label" style="width: 630px; border-bottom: 1px solid black;">

                                @if ($evento->detalle_montaje->isNotEmpty())
                                    @php $podium = $evento->detalle_montaje->pluck('podium')->filter()->implode(', '); @endphp
                                    @if ($podium)
                                        {{ $podium }}
                                    @endif
                                @endif
                    ...
                    <div class="row">
                        <span class="label">Rotafolio y plumon:</span>
                        <span class="label" style="width: 540px; border-bottom: 1px solid black;">

                                @if ($evento->detalle_montaje->isNotEmpty())
                                    @php $rotafolio = $evento->detalle_montaje->pluck('rotafolio_plumon')->filter()->implode(', '); @endphp
                                    @if ($rotafolio)
                                        {{ $rotafolio }}
                                    @endif
                                @endif
                    ...
                    <div class="row">
                        <span class="label">Banderas:</span>
                        <span class="label" style="width: 600px; border-bottom: 1px solid black;">

                                @if ($evento->detalle_montaje->isNotEmpty())
                                    @php $banderas = $evento->detalle_montaje->pluck('bandera')->filter()->implode(', '); @endphp
                                    @if ($banderas)
                                        {{ $banderas }}
                                    @endif
                                @endif
                    ...
                    <div class="row ">
                        ...
                        <div class="row">
                        <span >observacione del montaje:</span>
                        <p
            ...
            <section class="row" style="margin-top: 2px;">
