    ...
    <form action="{{ route($th['table'] . '.status') }}" method="post">
        ...
        <div class="row">
            <div class="col-12 h4 mt-2">
                <span class="mdi mdi-alert text-danger"></span> ¿Confirma que quiere anular esta requisicion?
            </div>
            <div class="col-12 mt-1">
                <div class="form-check">
                    <label class="form-check-label">
                        <input type="checkbox" class="form-check-input" name="confirm" id="" value="1" required>
                        Si, quiero anular esta requisicion
                    </label>
                </div>
            </div>
            <div class="col-12 mt-5">
                <button class="btn btn-danger" type="submit"><span class="mdi mdi-delete"></span> Anular</button>
