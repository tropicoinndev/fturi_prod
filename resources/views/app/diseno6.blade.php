            ...
            <section id="panel-main" class="mb-5"><!--Margen inferior entre la ultima card y el panel inferior de los botones-->
                ...
                <div v-show="getListado" id="panel-main-opacity"><!--Se usa para la opacidad-->
                    ...
                    <div v-for="p in getListado" class="panel-card mb-2"><!--Margen inferior entre cada card-->
                        <div class="row" data-bs-toggle="modal" data-bs-target="#modalAgregarCantidad"><!--Modal-->
                ...
                <div class="modal-dialog modal-xl modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div style="border-bottom: none;" class="modal-header">
                            <h1 class="modal-title fs-5 text-white text-uppercase ms-3" id="staticBackdropLabel">Cerveza Pilsener</h1>
                        ...
                        <div class="modal-body">
                            <div style="margin-top: -25px; border-bottom: solid 5px rgba(84, 110, 122, 51%);" class="panel-card-modal p-3 mb-3">
                                <div>
                                    <p style="color: #546E7A; font-size: 11px; margin-bottom: 2px;" class="text-uppercase">Salida de Bodega General</p>
                                    <p style="color: #37474F; font-size: 11px; margin-bottom: 5px;"><b>$ 15.75</b></p>

                                    <div>
                                        <p style="color: #546E7A; margin-bottom: 2px;">Cantidad: 2 · LOTE #5 · Ven. en 3 semanas</p>
                                        <!--style="border-color: #26C6DA;"-->
                                        <input aria-describedby="cantidadHelp" type="number" min="1" step="1" max="99999" class="form-control mb-2" placeholder="0">
                                        <div id="cantidadHelp" class="form-text text-danger">asdfg</div>
                                    </div>
                                    <div>
                                    ...
                                    <div class="row align-items-center">
                                        <div style="color: #546E7A; font-size: 11px; cursor: pointer;" class="col-6 mt-3">
                                            <p><i class="bi bi-check2-all"></i> Agregar observacion</p>
                                ...
                                <div class="text-uppercase text-center">
                                    ...
                                    <hr>
                                    <p>Verifique la existencia de <a href="#">productos.</a></p>
                                </div>
                            </div>
                        </div>
