                        ...
                        <div class="panel-card" @click="funcSeleccionarPrecio(pre)" data-bs-toggle="modal" data-bs-target="#modalAgregarCantidad">
                            <div class="row">
                                <div style="margin-top: -4px;" class="col-9">
                                    <b style="font-size: 12px; color: #37474F;" class="text-truncate text-uppercase ms-3">@{{ pre.id }} - @{{ pre.detalle }}</b>
        ...
        var app = new Vue({
            ...
            methods: {
                setBodega: function(bodega){
                    ...
                    this.buscarProductosEnBodega(this.bodegaSelectedId);
                },
                ...
                buscarProductosEnBodega: function(bodegasId){
