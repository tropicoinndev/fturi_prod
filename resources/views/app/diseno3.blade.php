...
@section('style')
    <style>
        ...
        #panel-main {/*Este es el panel de color blanco, sobre él se colocaran las card celestes*/
            ...
            height: auto;
            margin-top: 102px;
            z-index: 1;/*Aparecera encima del panel-header, tambien se modifica usando JS*/
        }
        ...
        .msjAlert {
            position: fixed;
            /*bottom: 10%;*/
            bottom: -10%;/*Posicion inicial fuera de la pantalla*/
            width: 50%;
            right: 1%;
            z-index: 100;
            ...
            <div id="panel-header" :class="{ 'active-search': showIconSearch }">
                ...
                <div v-show="showIconSearch" class="row justify-content-center">
                    <div class="col-12 col-sm-11">
                        <input v-model="txtSearch" type="text" class="form-control form-control-sm rounded-pill" placeholder="Buscar por nombre de producto">
                    </div>
                </div>
            </div>
        ...
        var app = new Vue({
            ...
            mounted(){
                ...
                window.addEventListener('scroll',function(){
                    ...
                    //Permite aumentar o reducir el tamaño del panel-header pero dependiendo si se ha hecho click en el boton de buscar,
                    //y tambien si ha habido algun desplazamiento previo hacia arriba o abajo
                    panelHeader.style.height = (!this.showIconSearch && currentScroll > 0) ? '60px' : '140px';
                    
                    //Muestra u oculta el boton scroll up, dependiendo si esta en la parte superior de la ventana o si se ha hecho scroll
                    if(currentScroll > 0){
                        panelHeader.classList.add('shrink');    //Reduce tamaño del panel-header
                        information.style.visibility = 'hidden';//Oculta los titulos
                        
                        panelMain.style.zIndex = '-1';           //El panel-main se envia hacia atras
                        ...
                        panelHeader.classList.remove('shrink');  //Se restablece el tamaño del panel-header
                        information.style.visibility = 'visible';//Muestra los titulos

                        panelMain.style.zIndex = '1';           //El panel-main se trae hacia adelante
