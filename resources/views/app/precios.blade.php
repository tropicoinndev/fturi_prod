    ...
    <div id="appPreciosMovil" class="container-fluid">
        <div class="row justify-content-center">
            ...
            <section :class="{'initBusqueda': !scrollInit && busquedaShow}" id="panel-main" class="mb-5"><!--Margen inferior entre la ultima card y el panel inferior de los botones-->
                ...
                <button @click="goToComandaActual" type="button" class="btn btn-outline-primary btn-sm rounded-5">Comanda</button>
                <p v-if="Object.keys(productosList).length > 0" style="color: #546E7A; font-weight: 500; font-size: 10.5pt;" class="text-uppercase mt-3 mb-1">Seleccione Un Producto</p>
