...
@section('ajustes_inventarios_content')
    <div id="appAjustesNegados" v-cloak>
        <div class="row mb-4">
            <div class="col-12">
                <h3 class="card-title text-uppercase mb-4">
                    <span class="mdi mdi-file-document-check text-danger h2"></span>
                    Ajustes negados
                </h3>
                <x-message></x-message>
            </div>
            ...
            @foreach($p as $s)
                @if($s->solicitante_users_id !== null)
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
                        <div class="estilo-card card border-danger h-100 w-100">
                            <div class="card-body">
                            ...
                            <div class="card-footer bg-transparent border-0">
                                <div class="row">
                                    ...
                                    <div class="col-12 text-end mb-1">
                                        <a href="{{ route('solicitud.detalle',['id'=>$s->cid]) }}" class="btn btn-outline-danger btn-sm rounded-5">Detalles</a>
                                    </div>
                                </div>
                            </div>
                        </div>
