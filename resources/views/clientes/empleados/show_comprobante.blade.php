        ...
        <div class="card-body p-2">
            ...
            <div class="row mb-3">
                <div class="col-12 mb-4">
                    <form action="/clientes/comprobantes/empleados/" method="get" id="form-mes">
            ...
            <div class="row">
                ...
                <div class="col-12 my-4">
                    ...
                    <button id="filter" class="btn btn-primary">Solo crédito</button>
                </div>

                @forelse ($data as $d)
                    @php
                        $has = $d->pagos->contains(function ($fp) {
                            return $fp?->forma_pagos?->token == 6002;
                        });
                    @endphp
                    <div class="col-12 mb-3 card-container {{ $has ? 'filtro' : '' }}">
