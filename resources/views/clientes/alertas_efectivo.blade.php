    ...
    <div class="container">
        <div class="card-body p-2">
            <h5 class="card-title text-uppercase mb-4 fw-bold">
                Clientes con alerta de ventas en efectivo
            </h5>

            <div class="row mb-2">
                <div class="col-12 mb-4">
                    <form action="{{ route('clientes.alertasEfectivoSearch') }}" method="post">
                        @csrf
                        ...
                        <tbody>
                            @foreach ($clientes as $c)
                                <tr>
                                    ...
                                    <td>{{ $c->nombre }}</td>
                                    @php
                                        $monto = $data->where('clientes_id', $c->id)->sum('total_efectivo');
