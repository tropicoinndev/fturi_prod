...
@section('dte_content')
    ...
    <div class="row mb-4">
        <div class="col-12">
            <form class="row g-3" action="{{ route('dte_anulaciones.historia_search') }}" method="POST">
                @csrf

                <div class="col-8">
                    <input type="text" step="1" class="form-control" placeholder="Buscar por titular"
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-light btn-sm"
                                    href="{{ route('dte_anulaciones.show', ['id' => Crypt::encryptString($d->id)]) }}">
