...
@section('form')
    <form action="{{ route('dte.contingenciasDelete') }}" method="post">
        @csrf

        <input type="hidden" name="id" value="{{ $p }}"><!--El id ya viene encriptado-->
        ...
        <div class="row">
            ...
            <div class="col-12 mt-5">
                ...
                <a class="btn btn-light" href="{{ URL::previous() }}"><span class=" mdi mdi-back"></span> Volver</a>
            </div>
        </div>
    </form>
@endsection
