        ...
        <tbody>
            ...
            <tr>
                ...
                <th class="text-right estilo-campos-factura borde-t-show bbl-radius">(I) {{ env('advalorem') * 100 }}%
                    AD-VALOREM</th>
                <th class="text-right estilo-campos-factura borde-t-show bbr-radius">
            ...
            {{-- Extension --}}
            @if (isset($json->extension) && $json->extension != null)
                <tr>
                    <td colspan="6" class="borde-l-none">
                        {{-- <b>EXTENSIÓN</b>
                        <p>
                            <b>ENTREGA:</b><br>
                            NOMBRE: {{ $json->extension?->nombEntrega }}<br>
                            DOCUMENTO: {{ $json->extension?->docuEntrega }}
                        </p>
                        <p>
                            <b>RECIBE:</b><br>
                            NOMBRE: {{ $json->extension?->nombRecibe }}<br>
                            DOCUMENTO: {{ $json->extension?->docuRecibe }}
                        </p> --}}
                        <p>
                            <b>OBSERVACIONES: </b>
