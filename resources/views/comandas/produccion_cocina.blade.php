...
@section('panel_produccion')
    <div id="pedidos">
        ...
        <div class="row p-4 panel-content">
            ...
            <h3 class="text-uppercase">Solicitudes a cocina</h3>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-4" v-if="p.aceptacion && p.espera && p.entregado == null">
                                    <div class="row">
                                        <div class="col-12 creacion fw-bolder mb-2 ">
...
@section('script')
    <script type="module">
        ...
        var app = appVue({
            ...
            created() {
                console.log('peidos')
                window.Echo.private('pedidos.cocina')
                    .listen('PedidosCocina', (d) => {
            ...
            computed: {
                getSolicitudes: function() {
                    ...
                    return this.comanda_detalles.filter(
                        ...
                        (this.filterPedidos.length == 0 || this.filterPedidos.includes(c.comandas_id))
                    ).sort((a, b) => {
            ...
            methods: {
                getData: function() {
                    axios.post("{{ route('comandas.produccion_cocina') }}", {
                ...
                setTerminado: function(producto) {
                    try {
                        ...
                        if (producto.id > 0) {
                            ...
                            this.setMessage(
                                `Entrega inmediata del producto ${producto.cantidad} - ${producto.dprecio.detalle} comanda #${producto.comandas_id}, se aviso a ${producto.comandawtcaja.cajas.caja}.`
                            );
                        }
                    } catch (error) {
                        console.log(error);
                ...
                getNotifyPermission: function() {
                    console.log('Get Notify', Notification.permission);
                    if (Notification.permission === "granted") {
                        console.log('Permite notificacion');
                        this.notify = true;
