        ...
        <div class="card-body p-2">
            <div class="row mb-2">
                <div class="col-12 text-uppercase h3">
                    Reporte de ventas por comandas
                </div>
            </div>

            <div class="row mb-2">
                <div class="col-12">
                    <form action="{{ route('comandas.reporteVentasAcciones') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="1" id="detallado"
                                            name="detallado">
                                        <label class="form-check-label" for="detallado">
                                            Reporte con comandas detalladas
                                        </label>
                                    </div>
                                </div>
                            </div>
