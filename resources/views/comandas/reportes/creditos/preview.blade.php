        ...
        <div class="card-body p-2">
            <div class="row mb-2">
                <div class="col-12 text-uppercase h3">
                    Vista previa de comandas en crédito
                </div>
                ...
                <div class="col-12 my-2">
                    <a class="btn btn-light" href="{{ route('comandas.reporteCreditos') }}" role="button">Volver</a>
                </div>
            </div>
                        ...
                        <tbody>
                            ...
                            @foreach ($data as $d)
                                ...
                                <tr>
                                    ...
                                    @endphp
                                    <td>
                                        <span class="badge badge-pill {{ $vencido ? 'bg-danger' : 'bg-success' }}">
