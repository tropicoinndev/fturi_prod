        ...
        <div class="card-body p-2">
            <div class="row mb-2">
                <div class="col-12 text-uppercase h3">
                    Vista previa de anulaciones de comandas
                </div>
                ...
                <div class="col-12 my-2">
                    <a class="btn btn-light" href="{{ route('comandas.reporteAnulaciones') }}" role="button">Volver</a>
                </div>
            </div>
                        ...
                        <tbody>
                            ...
                            @foreach ($data as $d)
                                ...
                                <tr>
                                    ...
                                    <td>{{ $d->cantidad }}</td>
                                    <td>
                                        {{ $d->comanda_detalles->precios->detalle }}
                                        <br>
                                        <small>
                                            <i>
                                                {{ $d->observacion }}
                            ...
                            @endforeach
                            <tr>
                                <td class="text-uppercase fw-bold bt-2" colspan="2">
                                    TOTAL:
                                </td>
                                <td class="text-end fw-bold bt-2">{{ $cantidad }}</td>
                                <td class="text-end fw-bold bt-2"></td>
