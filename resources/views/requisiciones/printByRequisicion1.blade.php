...
<head>
    ...
    <title>Impresion de requisicion #{{ $p->id }}</title>
    ...
    <style>
        ...
        *{
        ...
        tr {
            page-break-inside: avoid; /* Evitar que se corte una fila */
        }
    ...
    <main>
        ...
        <table class="border rounded-3 mw-100 text-uppercase">
            ...
            <tr>
                <td class="h6">
                    <b>
                        REQUISICION: <small>{{ $p->solicitud }}</small>
                    </b>
                </td>
                <td class="p-3">
                    <div style="width: 20%; float: left;">
                ...
                <td colspan="3">
                    <div class="container">
                        ...
                        <div class="left-container" style="width: 50%; float: left;">
                            ...
                            <div class="cell">
                                Bodega de entrada:<u>
                                    {{ $p->relacionBodegasEntrada->bodega }}
                                </u>
                            </div>
                            ...
                            <div class="cell">
                                Bodega de salida:<u>
                                    {{ $p->relacionBodegasSalida->bodega }}
                                </u>
                            </div>
                        </div>
                        ...
                        <div class="right-container" style="width: 50%; float: right;">
                            ...
                            <div class="cell">
                                Responsable que autoriza:<u>
                                    {{ optional($p->relacionUserAutorizacion)->name ?? 'Requisicion sin autorizar' }}
                                </u>
                            </div>

                            <!-- Celda para Usuario que solicita -->
                            <div class="cell">
                                Usuario que solicita:<u>
                                    {{ $p->relacionUserCreacion->name }}
                                </u>
                            </div>
                        </div>
                    </div>
            ...
            <tr class="mb-4">
                <td colspan="3" class="table table-striped table-inverse border rounded-3 mw-100 text-uppercase">
                    <small>
                            ...
                            <tbody>
                                @foreach ($d as $dr)
                                    <tr>
                                        ...
                                        <td scope="row">$ {{ $dr->relacionExistencias->precio_costo }}</td>
                                        <td scope="row">$ {{ number_format($dr->relacionExistencias->precio_costo * $dr->cantidad, 2) }}</td>
