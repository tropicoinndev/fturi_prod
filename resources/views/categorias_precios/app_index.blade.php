...
<div id="appListarCategoriasPrecios">
        ...
        <div class="row justify-content-center" style="margin-top: -24px;">
            ...
            <div class="menuSinScroll" id="menu">
                <div class="container-fluid mt-3">
                    <div class="row">
                        <div class="col-1">
                            <a href="{{ route('categorias.movil.index') }}" style="text-decoration: none;">
                                <i class="bi bi-arrow-left"></i>
                            </a>
                        </div>
                        <div class="col-9">
                            <h1 style="margin-top: 8px;" class="title ms-2">@{{ categorias.categoria }}</h1>
                            <div id="titles">
            ...
            <div class="panel-main">
                ...
                {{-- @{{ categoriasPrecios }} --}}
                <div class="row mt-1">
                    {{-- <div v-for="catP in getCategoriasPrecios" class="col-12 mb-2">
                        <div class="panel-card">
                            <div class="row" data-bs-toggle="modal" data-bs-target="#modalAgregarCantidad">
                                <div style="margin-top: -4px;" class="col-9">
                                    <b style="font-size: 12px; color: #37474F;" class="text-truncate text-uppercase ms-3">@{{ catP.categoria }}</b>
                                    <p style="color: #546E7A; font-size: 10px; margin-top: -1px; margin-bottom: -2px;" class="ms-3 text-uppercase">@{{ catP.descripcion }}</p>
                                </div>
                                <div style="margin-top: -4px;" class="col-3 text-end">
                                    <b style="color: #37474F; font-size: 13px;" class="me-2">$ 0.00</b>
                                </div>
                            </div>
                        </div>
                    </div> --}}

                    <div v-for="pro in getProductos" class="col-12 mb-2">
                        <div class="panel-card">
                            <div class="row" data-bs-toggle="modal" data-bs-target="#modalAgregarCantidad">
                                <div style="margin-top: -4px;" class="col-9">
                                    <b style="font-size: 12px; color: #37474F;" class="text-truncate text-uppercase ms-3">@{{ pro.nombre }}</b>
                                    <p style="color: #546E7A; font-size: 10px; margin-top: -1px; margin-bottom: -2px;" class="ms-3 text-uppercase">...</p>
                                </div>
                                <div style="margin-top: -4px;" class="col-3 text-end">
                                    <b style="color: #37474F; font-size: 13px;" class="me-2">$ 0.00</b>
                                </div>
        ...
        var app = new Vue({
            ...
            computed: {
                getCategoriasPrecios: function(){
                    ...
                    return this.categoriasPrecios.data.filter(c => regx.test(c.categoria.toLowerCase()) || regx.test(c.id));
                },

                getProductos: function(){
                    let regx = new RegExp((this.txtBusqueda).toLowerCase());
                    //No se usa la propiedad 'data' en el filter, ya que la variable $data['productos'] que viene desde el controlador es un array, y no un objeto de paginador de Laravel.
                    //Por lo tanto, ya se puede recorrer el array en el v-for.
                    return this.productos.filter(pro => regx.test(pro.nombre.toLowerCase()) || regx.test(pro.id));
                },
            }
        });
    </script>
