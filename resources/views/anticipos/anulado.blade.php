...
@section('panel_anticipo')
    <div id="AnticipoAnulado" class="container">
        <div class="card panelCalendar">
            <div class="card-body p-5">
                <form action="{{ route('anticipos.reporte_anulado_buscar') }}" method="post">
                    @csrf
                    <div class="row mb-2">
                        <div class="card-title col-12 h5 text-uppercase mb-4">REPORTE DE ANTICIPOS ANULADOS</div>
                        <div class="col-6">
