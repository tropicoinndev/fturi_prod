        ...
        <div class="row justify-content-center" style="margin-top: -24px;">
            ...
            <div class="menuSinScroll" id="menu">
                <div class="container-fluid mt-3">
                    <div class="row">
                        <div class="col-1">
                            <a href="{{ route('listar.categorias') }}" style="text-decoration: none;">
                                <i class="bi bi-arrow-left"></i>
                            </a>
                        </div>
                        <div class="col-9">
                            <h1 style="margin-top: 8px;" class="title ms-2">BEBIDAS PREPARADAS</h1>
                            <div id="titles">
            ...
            <div class="panel-main">
                ...
                <div class="row mt-1">
                    @php
                        $comandas = [
                            ['producto'=>'COÑAC',       'bodega'=>'BEBIDA PREPARADA', 'precio'=>1.2],
                            ['producto'=>'PIÑA COLADA', 'bodega'=>'BEBIDA PREPARADA', 'precio'=>1.75],
                            ['producto'=>'MARGARITA',   'bodega'=>'BEBIDA PREPARADA', 'precio'=>5.25],
                            ['producto'=>'COÑAC',       'bodega'=>'BEBIDA PREPARADA', 'precio'=>2.50],
                            ['producto'=>'PIÑA COLADA', 'bodega'=>'BEBIDA PREPARADA', 'precio'=>2.50],
                            ['producto'=>'MARGARITA',   'bodega'=>'BEBIDA PREPARADA', 'precio'=>2.50],
                            ['producto'=>'COÑAC',       'bodega'=>'BEBIDA PREPARADA', 'precio'=>1.2],
                            ['producto'=>'PIÑA COLADA', 'bodega'=>'BEBIDA PREPARADA', 'precio'=>1.75],
                            ['producto'=>'MARGARITA',   'bodega'=>'BEBIDA PREPARADA', 'precio'=>5.25],
                            ['producto'=>'COÑAC',       'bodega'=>'BEBIDA PREPARADA', 'precio'=>1.2],
                            ...
                            <div class="panel-card">
                                <div class="row" data-bs-toggle="modal" data-bs-target="#modalAgregarCantidad">
                                    <div style="margin-top: -4px;" class="col-9">
                                        ...
                                        <p style="color: #546E7A; font-size: 10px; margin-top: -1px; margin-bottom: -2px;" class="ms-3">{{ $c['bodega'] }}</p>
                                    </div>
